...
equal(Logic.hideGlyph(false, false), "eye")
equal(Logic.hideGlyph(false, true), "eye-off")
equal(Logic.hideGlyph(true, false), "eye-off")
equal(Logic.hideGlyph(true, true), "eye")
...
assert(favorite.props.selected == nil, "favorite must not use the selected chrome")
...
assert(unfavorited.props.selected == nil, "favorite must not use the selected chrome")
...
equal(hide.props.glyph, "eye")
equal(hide.props.tooltip, "Hide (x)")
hide.props.onHover("true", "hide")
hide = assert(button(rendered, "hide"), "hide button missing after hover")
equal(hide.props.glyph, "eye-off")
hide.props.onHover("false", "hide")
hide = assert(button(rendered, "hide"), "hide button missing after hover release")
equal(hide.props.glyph, "eye")
hide.props.onClick()
...
equal(restore.props.glyph, "eye-off")
...
equal(assert(button(rendered, "hide")).props.glyph, "eye", "caption state must follow the re-read current")
